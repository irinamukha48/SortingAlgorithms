 ...
 * and will sort them in an ascending order using the Cocktail Shaker Sort method.
 * Cocktail Shaker Sort method compares two consecutive numbers and switches them if the greter number is on the left.
 * If it reaches the end of the list, it will go from the end to the beginning, and repeat until everything is sorted.
 *
 * @IMukhametzhanova
 * @1.8
 * 7/23/18
...
public class CocktailShakerSort_IM
{
